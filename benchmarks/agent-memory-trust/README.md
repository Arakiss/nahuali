...
|---|---|---|---|---|
| Nahuali | 0.8.0-beta.8 | First-party | Source build | [7 pass, 0 fail, 0 unsupported](results/nahuali-0.8.0-beta.8.json) |
...
python3 benchmarks/agent-memory-trust/adapters/nahuali.py \
  --binary target/release/nahuali \
  --source-revision "$(git rev-parse HEAD)" \
  --output benchmarks/agent-memory-trust/results/nahuali-0.8.0-beta.8.json
python3 benchmarks/agent-memory-trust/score.py \
  benchmarks/agent-memory-trust/results/nahuali-0.8.0-beta.8.json
```
