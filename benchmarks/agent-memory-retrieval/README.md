...
[`nahuali-0.8.0-beta.10.json`](results/nahuali-0.8.0-beta.10.json).

| Mode | Recall@1 | Recall@3 | MRR | nDCG@10 | Median latency | p95 latency |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Lexical | 1.000 | 1.000 | 1.000 | 1.000 | 29.5 ms | 35.0 ms |
| Deterministic hybrid | 1.000 | 1.000 | 1.000 | 1.000 | 34.2 ms | 46.4 ms |
