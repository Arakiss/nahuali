...
assert_file_contains .github/workflows/ci.yml 'repos/\$\{GITHUB_REPOSITORY\}/statuses/\$\{GITHUB_SHA\}' "CI rollup must publish workflow_dispatch results as a visible commit status"
