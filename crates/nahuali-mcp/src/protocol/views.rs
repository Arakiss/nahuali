use nahuali_core::{
    ...
    Entity, Episode, Fact, GoalProgress, GoalProgressReport, GraphProjectionRebuildReport,
    GraphProjectionStatus, GraphProjectionValidation, HealthSignal, IngestionCounts,
    IngestionIssue, IngestionPreflight, IngestionReport, Intention, IntentionReconciliationIssue,
    IntentionReconciliationReport, KnowledgeHealth, Link, MemoryBriefingReport,
    MemoryConsolidationPlanReport, MemoryGraphEdge, MemoryGraphNode, MemoryGraphReport,
    MemoryGraphSummary, MemoryHookDirective, MemoryHookReport, MemoryHookSummary,
    MemoryProactiveReport, MemoryReflectionReport, MemoryScope, MemorySleepReport,
    OperatorReviewItem, OperatorReviewReport, OperatorReviewSummary, ProactiveSummary, Procedure,
    RecallResult, RecordLedgerIssue, ReflectionCycle, ReflectionFinding, ReflectionSourceCoverage,
    ReflectionSummary, Relation, ReviewResolutionReport, SelfInspectionFinding,
    SelfInspectionReport, SelfInspectionReviewItem, SelfInspectionSummary,
    SelfInspectionWriteBackPolicy, SleepConsolidationCandidate, SleepEpisodeReplay,
    SleepModeSummary, SleepStage, TextIngestBuildReport, TextIngestIssue,
};
