use nahuali_core::{
    ...
    EmbeddingProviderConfig, Entity, Episode, Fact, GoalProgress, GoalProgressReport,
    GraphProjectionRebuildReport, GraphProjectionStatus, GraphProjectionValidation, HealthSignal,
    IngestionCounts, IngestionIssue, IngestionPreflight, IngestionReport, Intention,
    ...
    SelfInspectionSummary, SelfInspectionWriteBackPolicy, SemanticIndexReport, SemanticIndexStatus,
    SemanticPointSummary, SleepConsolidationCandidate, SleepEpisodeReplay, SleepModeSummary,
    SleepStage, TextIngestBuildReport, TextIngestIssue,
};
