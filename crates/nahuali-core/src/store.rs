...
use crate::{
    ...
    AutonomyLevel, MemorySleepReport, ProactiveOptions, RecallOptions, ReflectionOptions,
    RepairKind, RepairProposal, RepairReport, ReviewResolutionOptions, ReviewResolutionReport,
    SleepModeOptions,
    ...
    projection, recall, reflection, review_writeback, self_repair,
